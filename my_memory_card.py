...
question_list.append(Question('Какая буква последняя в алфавите?', 'Я', 'А', 'Э', 'Ю'))
question_list.append(Question('28 в двоичной системе?', '00011100', '00010101', '0111', '1011'))
question_list.append(Question('какой компанией разработано расширение аудиофала .wav?', 'Microsoft', 'HoYoVerse', 'Adobe', 'Oracle'))
question_list.append(Question('Какое сочитание клавиш открывает диспечер задач?', 'CTR+SHIFT+ESC', 'WIN+D', 'CTRL+ALT+DEL', 'ALT+F4'))
question_list.append(Question('Какая ОС от Microsoft вышла в 1993?', 'windows 3.11', 'Windows 11', 'windows 7', 'windows 95'))
